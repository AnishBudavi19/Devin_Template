...
echo ""
echo "┌─────────────────────────────────────────────────────────────┐"
echo "│ Autonomous Business Operations Center (ABOC)               │"
echo "│ AI-Powered Incident & Operations Automation Platform       │"
echo "│                                                           │"
echo "│ Supported Workflows:                                      │"
echo "│ • IT Incident Management                                  │"
echo "│ • Customer Complaint Handling                             │"
echo "│ • Service Request Processing                              │"
echo "│ • System Alert Monitoring                                 │"
echo "│ • Infrastructure Failure Response                         │"
echo "│                                                           │"
echo "│ AI Agents:                                                │"
echo "│ • Intake Agent                                            │"
echo "│ • Priority Classification Agent                           │"
echo "│ • Assignment Agent                                        │"
echo "│ • Escalation Agent                                        │"
